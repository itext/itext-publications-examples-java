...
public class PdfDenseMergeExample {
    ...
    public static final String SRC1 = "./src/test/resources/pdfs/merge1.pdf";
    public static final String SRC2 = "./src/test/resources/pdfs/merge2.pdf";
    public static final String SRC3 = "./src/test/resources/pdfs/merge3.pdf";
    public static final String SRC4 = "./src/test/resources/pdfs/merge4.pdf";
