...
public class SignatureExample {
    ...
    public static final String SRC = "./src/test/resources/pdfs/signExample.pdf";
    public static final String CERT_PATH = "./src/test/resources/cert/signCertRsa01.p12";
    public static final String IMAGE_PATH = "./src/test/resources/img/sign.jpg";
