...
public class C07E11_HelloFormFlattened {
     ...
     */
    public static final String DEST = "./target/htmlsamples/ch07/form_flattened.pdf";

    /**
     * The path to the source HTML file.
     */
    public static final String SRC = "./src/test/resources/htmlsamples/html/form.html";
