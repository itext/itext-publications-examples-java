...
public class C07E13_Peace {
     ...
     */
    public static final String FONTS = "./src/test/resources/htmlsamples/fonts/noto/";
     ...
     */
    public static final String SRC = "./src/test/resources/htmlsamples/html/peace.html";
