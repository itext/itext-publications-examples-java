...
public class C06E05_ExtraFont {
     ...
     */
    public static final String DEST = "./target/htmlsamples/ch06/fonts_extrafont.pdf";

    /**
     * The path to the source HTML file.
     */
    public static final String SRC = "./src/test/resources/htmlsamples/html/fonts_extra.html";

    /**
     * The path to an extra font.
     */
    public static final String FONT = "./src/test/resources/htmlsamples/fonts/cardo/Cardo-Regular.ttf";
