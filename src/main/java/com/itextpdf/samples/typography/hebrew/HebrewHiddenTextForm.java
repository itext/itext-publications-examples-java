...
package com.itextpdf.samples.typography.hebrew;
...
public class HebrewHiddenTextForm {
    ...
    public static final String DEST = "./target/samples/typography/HebrewHiddenTextForm.pdf";
    public static final String FONTS_FOLDER = "./src/main/java/com/itextpdf/samples/typography/hebrew/resources/";
    public static final String RESOURCE_FOLDER = "./src/main/java/com/itextpdf/samples/typography/hebrew/resources/";
