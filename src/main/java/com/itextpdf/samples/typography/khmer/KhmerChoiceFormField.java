...
package com.itextpdf.samples.typography.khmer;
...
public class KhmerChoiceFormField {
    ...
    public static final String DEST = "./target/samples/typography/KhmerChoiceFormField.pdf";
    public static final String FONTS_FOLDER = "./src/main/java/com/itextpdf/samples/typography/khmer/resources/";
