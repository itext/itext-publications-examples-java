...
package com.itextpdf.samples.typography.latin;
...
public class LatinSignature {
    ...
    public static final String FONTS_FOLDER = "./src/main/java/com/itextpdf/samples/typography/latin/resources/";
    public static final String RESOURCE_FOLDER = "./src/main/java/com/itextpdf/samples/typography/latin/resources/";
    public static final String CERTIFICATE_FOLDER = "./src/main/java/com/itextpdf/samples/typography/latin/resources/";
