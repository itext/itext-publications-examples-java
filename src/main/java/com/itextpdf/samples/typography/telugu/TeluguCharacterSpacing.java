...
package com.itextpdf.samples.typography.telugu;
...
public class TeluguCharacterSpacing {
    ...
    public static final String DEST = "./target/samples/typography/TeluguCharacterSpacing.pdf";
    public static final String FONTS_FOLDER = "./src/main/java/com/itextpdf/samples/typography/telugu/resources/";
